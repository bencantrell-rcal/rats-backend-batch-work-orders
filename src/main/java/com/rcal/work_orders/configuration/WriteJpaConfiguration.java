package com.rcal.work_orders.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.rcal.work_orders.repository.write", entityManagerFactoryRef = "writeEntityManagerFactory", transactionManagerRef = "writeTransactionManager")
public class WriteJpaConfiguration{
  ...
  public LocalContainerEntityManagerFactoryBean writeEntityManagerFactory(){
    ...
    emf.setPackagesToScan("com.rcal.work_orders.entity");
