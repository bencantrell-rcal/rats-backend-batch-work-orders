...
@Configuration
@EnableJpaRepositories(basePackages = "com.rcal.work_orders.repository.read", entityManagerFactoryRef = "readEntityManagerFactory", transactionManagerRef = "readTransactionManager")
